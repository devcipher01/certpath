...
// Since CertifyPath has no auth, this is the only local fallback so users can
// recover their cert URL without keeping the email receipt.

export interface SavedCert {
  certUrl: string;       // full absolute URL, e.g. https://certifypath.online/certificate/...
...
const STORAGE_KEY = "certifypath_certs";
